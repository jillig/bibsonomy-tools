...
public class PluginProperties extends Properties {
	...
	public static GroupingEntity getDefaultVisibilty() {
		...
		String grouping = getInstance().getProperty(PLUGIN_VISIBILITY, "ALL");
		return GroupingEntity.getGroupingEntity(grouping);
	}
	...
	public static void setDefaultVisisbility(GroupingEntity key) {
		getInstance().setProperty(PLUGIN_VISIBILITY, key.toString());
	}
